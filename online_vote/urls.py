...
urlpatterns = [
    ...
    path('password_reset/', PasswordResetView.as_view(template_name='main/password_reset.html',html_email_template_name = 'muni_election/pw_reset_email.html',subject_template_name ='muni_election/pw_reset_subject.txt'), name='password_reset'),
